...
module.exports = {
    // ===== BOT CORE SETTINGS =====
 SESSION_ID: process.env.SESSION_ID || "baymax~UW9ADZaA#lIJtL07dlbvSpBvyFXBWUGfRbMWTWeJ3AMB9VDPtf1E",
  PREFIX: getConfig("PREFIX") || ".",
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*BAYMAX MD VIEWED YOUR STATUS 🤖*",  // Status reply message
    ...
    MENU_IMAGE_URL: getConfig("MENU_IMAGE_URL") || "https://i.ibb.co/mWtJPyP/file-0000000039a461f7940ebd4ffe7226ef.png",  // Bot's "alive" menu mention image
