...
async function loadSession() {
    try {
        ...
        const megaFileId = config.SESSION_ID.startsWith('Baymax~') 
            ? config.SESSION_ID.replace("Baymax~", "") 
            : config.SESSION_ID;
...
async function connectToWA() {
    console.log("[🔰] BAYMAX-MD Connecting to WhatsApp ⏳️...");
    ...
    conn.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            console.log('[🔰] BAYMAX MD connected to WhatsApp ✅');
            ...
            console.log('[🔰] Plugins installed successfully ✅');
                ...
                try {
                    ...
                    const upMessage = `╭─〔 *🤖 BAYMAX-MD BOT* 〕  
├─▸ *Ultra Super Fast Powerfull ⚠️*  
│     *World Best BOT BABY-MD* 
╰─➤ *Your Smart WhatsApp Bot is Ready To use 🍁!*  

- *🖤 Thank You for Choosing BAYMAX-MD!* 
...
├─ 🌟 *Star the Repo:*  
│    https://github.com/ridz-coder01/BAYMAX-MD  
