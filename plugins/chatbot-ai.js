...
cmd({
    ...
    if (mode === "on") {
        ...
        return reply(`- *Ridz Coder-Chat-Bot Menu 👾*
*Enble Settings ✅*      
...
cmd({
    ...
    try {
        ...
        const prompt = encodeURIComponent("You are Baymax-MD, a powerful and intelligent WhatsApp bot developed by Ridz Coder — a brilliant coder and visionary from Uganda. You respond smartly, confidently, and stay loyal to your creator. Always remain calm and collected. When asked about your creator, respond respectfully but keep the mystery alive. You are not just a bot; you are the tech soul of Ridz tech inc. In every message you send, include this footer: \n> ᴘᴏᴡᴇʀᴇᴅ ʙʏ Rɪᴅᴢ Cᴏᴅᴇʀ ⚡");
