...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/Ridz-coder01/BAYMAX-MD';
...
`.trim();
        ...
        await conn.sendMessage(from, {
            image: { url: `https://i.ibb.co/mWtJPyP/file-0000000039a461f7940ebd4ffe7226ef.png` }, // Replace with your image URL
